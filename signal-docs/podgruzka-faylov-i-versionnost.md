---
order: 2
title: Загрузка файлов и версионность
---
...
Если по какой-то причине потребовалось изменить шифр или наименование файла или номер листа - при замене файла нужно переименовать и старый файл на портале и только после этого подгружать поверх новый - иначе не будет контроля версий.
